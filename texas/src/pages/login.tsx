...
const INFO_LIST: InfoProps[] = [
  {
    title: "2022/05/20 🎉正式版🎉",
    children: (
      <>
        <Title order={4} align="center" my="md">
          🎉壢中Scoreboard正式版🎉
        </Title>
        雖然還有一些需要改善的地方，不過我懶得改了。以下有三點注意事項：
        <br />
        <br />
        <Title order={5}>1. 請以學校成績查詢網站為準</Title>
        有時候我也不敢相信我的成績竟然如此低分，這時請到學校的成績查詢網站再次確認。
        如果你在這時發現學校成績查詢網站沒有開放，請保持低調等待開放後再查一次。
        <br />
        <br />
        <Title order={5}>2. 請定期關閉應用程式</Title>
